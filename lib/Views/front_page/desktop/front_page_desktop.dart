...
class FrontPageDesktop extends StatefulWidget {
  const FrontPageDesktop({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => FrontPageDesktopView();
}

class FrontPageDesktopView extends State<FrontPageDesktop> {
  String? accessToken;
  @override
