...
import 'package:control_panel/protobuf/packet.pb.dart';
...
const String HUB_UUID = "170e6a4c-af9e-4a1f-843e-e4fb5e165c62";
const String READ_UUID = "2630acab-7bf5-4dee-97fb-af8d3955c2aa";
                  ...
                  while (!breakout) {
                    ...
                    if (response.whichType() ==
                      ...
                      final channel = WebSocketChannel.connect(
                        Uri.parse(
                            '$remoteWsDomain/api/v1/confirm-added-hub?accessToken=${widget.accessToken}'),
                      );
