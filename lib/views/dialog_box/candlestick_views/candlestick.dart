  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      if (data[i]["open"] > data[i]["close"]) {
        ...
        // Draw volume bars
        Rect volumeRect =
            Rect.fromLTRB(rectLeft, volumeBarTop, rectRight, volumeBarBottom);
      ...
      canvas.drawLine(
          ...
          rectPaint);
      canvas.drawLine(Offset(rectLeft + rectWidth / 2 - lineWidth / 2, rectTop),
          Offset(rectLeft + rectWidth / 2 - lineWidth / 2, high), rectPaint);
    }
  }
